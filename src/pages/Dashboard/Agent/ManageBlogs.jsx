...
const ManageBlogs = () => {
  ...
  return (
    <div className="container mx-auto px-4 pt-0 pb-8">
      <h1 className="text-4xl font-bold text-center mb-4">Manage Blogs</h1>
      ...
      <div className="relative overflow-x-auto shadow-xl sm:rounded-lg w-full border border-gray-200 dark:border-gray-700">
