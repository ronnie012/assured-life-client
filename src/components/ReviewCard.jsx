...
const ReviewCard = ({ review }) => {
  return (
    <div className="max-w-sm text-center p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition-all duration-300  hover:shadow-xl min-h-[250px] flex flex-col justify-between">
