    ...
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      <nav className="flex flex-col p-4 bg-gray-800 dark:bg-gray-950 text-white w-64 space-y-2">
        <ul className="space-y-2">
          ...
          <li>
            <Link to="/dashboard/admin/applications" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
          ...
          <li>
            <Link to="/dashboard/admin/users" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
              <HiInbox className="w-6 h-6 text-gray-400 transition duration-75 group-hover:text-white" />
              <span className="ml-3">Manage Users</span>
            </Link>
          </li>
          <li>
            <Link to="/dashboard/admin/policies" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
          ...
          <li>
            <Link to="/dashboard/admin/transactions" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
          ...
          <li>
            <Link to="/dashboard/admin/agents" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
